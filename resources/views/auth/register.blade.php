            ...
            <div
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <input id="name" type="text" name="name" value="{{ old('name') }}" placeholder="Nombre de usuario"
                        class="block w-full py-3 px-1 mt-2text-gray-800 appearance-none border-b-2 border-gray-100 focus:text-gray-500 focus:outline-none focus:border-gray-200"
                        required />
                    ...
                    <label for="password" class="block text-xs font-semibold text-gray-600 uppercase">Contraseña</label>
                    ...
                    <input id="password-confirmation" type="password" name="password_confirmation" placeholder="Contraseña"
